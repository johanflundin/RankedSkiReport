...
function ShellPage1({ resort }: { resort: Resort }) {
  return (
    <Page side="left" folio="1" fullBleed>
      <div style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        />
        <div className="folio folio-bottom left" style={{ color: 'var(--snow)', textShadow: '0 1px 2px rgba(0,0,0,.6)' }}>1</div>
        {resort.forthcoming && (
...
function ShellPage2({ resort, entryNumber }: { resort: Resort; entryNumber: number }) {
  return (
...
function ShellPage3({ resort }: { resort: Resort }) {
  return (
...
function ShellPage4({ resort }: { resort: Resort }) {
  return (
...
function ShellPage5({ resort }: { resort: Resort }) {
  return (
...
function ShellPage6({ resort }: { resort: Resort }) {
...
export function getShellSpreads(resort: Resort, entryNumber: number): Array<{ left: ReactNode; right: ReactNode }> {
  return [
