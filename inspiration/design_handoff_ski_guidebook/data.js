// 20 entries, ordered by visit chronology (not ranking).
// Whistler is fully built; the rest are shells.
// Entries marked __placeholder are my additions to round out to 20 — swap freely.
window.RESORTS = [
...
window.WHISTLER_INDEX = window.RESORTS.findIndex(r => r.slug === 'whistler');
